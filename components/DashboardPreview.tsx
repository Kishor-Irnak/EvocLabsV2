...
const StatCard = ({
  ...
  <div className="p-4 rounded-xl border border-border bg-surface flex flex-col justify-between hover:border-border transition-colors group">
    ...
    <div>
      <div className="text-2xl font-bold text-text-main tracking-tight mb-1 group-hover:text-primary transition-colors">
        {value}
      </div>
      <div
          ...
          <div className="flex-1 rounded-xl border border-white/5 bg-[#0A0A0A] p-6 relative overflow-hidden group">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex bg-white/5 rounded-lg p-0.5 border border-white/5">
                <button className="px-3 py-1 rounded-md text-xs font-medium bg-white/10 text-white shadow-sm">
                  12M
                </button>
                <button className="px-3 py-1 rounded-md text-xs font-medium text-text-muted hover:text-text-main">
                  30D
                </button>
                <button className="px-3 py-1 rounded-md text-xs font-medium text-text-muted hover:text-text-main">
                  7D
